...
\ihead[]{\begin{tabular}{cl}
	\multirow{3}{*}{\includegraphics[scale=0.48]{inc/img/uds_logo.png}} & \coursename{} \\
	& \term{} \\
	& \university{}
\end{tabular}}

\ohead[]{\begin{tabular}{rc}
	\professor{} & \multirow{3}{*}{\includegraphics[scale=0.165]{inc/img/imsl_logo.pdf}} \\
	\assistant{} \\
	\assigment{}
\end{tabular}}
...
\setkomafont{pageheadfoot}{\color{scr-gray-2} \small}
